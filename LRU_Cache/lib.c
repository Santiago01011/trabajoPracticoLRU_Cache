...
termine descartando eso porque segun el enunciado "Si el dato ya exist�a (misma clave), es
...
/**
 * @brief agregar_lrucache
 * 
 * Agrega un dato a la cache, siempre en la primer posición. Si el elemento ya estaba en la caché o
 * si la cache esta llena se elimina el ultimo elemento
 * 
 * @param pc puntero a la cache
 * @param dato puntero al dato a agregar
 * @param tam tamaño del dato
 * 
 * @return 1 si se agrego correctamente, 0 si no hay memoria
 */
